...
namespace ScheduleMaster
{
    public partial class AllDataViewer : Form
    {
        ...
        public void LoadRooms()
        {
            ...
            ClassroomBox.AutoCompleteCustomSource.Clear();
        ...
        private void InsertButton_Click(object sender, EventArgs e)
        {
            ...
            if (SubjectBox2.Text.Length != 0)
            {
                ...
                if (id < 0)
                {
                    ...
                    SubjectBox.AutoCompleteCustomSource.Add(SubjectBox2.Text);
        ...
        {
            if (MainData.SelectedRows.Count != 1) return;
            ProfessorBox.Text = "";
            ClassroomBox.Text = "";
            SubjectBox.Text = "";
            DataRow r = MainDataTable.Rows[MainData.SelectedRows[0].Index];
            ProfessorList.SelectedItem = Program.db.GetProfessor(r["Professor"].ToString());
            RoomList.SelectedItem = Program.db.GetRoom(new Room(r["Classroom"].ToString()));
